...
exports.runSync = exports.executeAsync = exports.executeSync = exports.hasWdioSyncSupport = exports.wrapCommand = exports.runFnInFiberContext = exports.executeHooksWithArgs = exports.switchSyncFlag = exports.asyncSpec = exports.runAsync = void 0;
...
async function executeAsync(fn, retries, args = []) {
    ...
    try {
        ...
        if (result && typeof result.finally === 'function') {
            result.finally(() => (exports.asyncSpec = asyncSpecBefore));
        }
        else {
